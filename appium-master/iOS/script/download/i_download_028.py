...
class i_download_028(unittest.TestCase):
    def setUp(self):
    ...
    # ID: Download-028
    # Des: 进入单集付费专辑页面查看“批量下载”按钮
    def download_028(self):   
        ...
        TypeTextField.set_value(u'第一傲世皇后')
        sleep(1)
        ...
        bulkDownloadPage = self.driver.find_element_by_accessibility_id('第一傲世皇后')
